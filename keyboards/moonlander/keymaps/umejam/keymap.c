...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_moonlander(
        ...
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    TG(SYMB),         TG(MDIA), KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_EQL,
        KC_BSLS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    RESET,            KC_MINS,  KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                                KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_LSFT,
        KC_LANG2,KC_GRV,  A(KC_X), KC_LEFT, KC_RGHT,          KC_LALT,          KC_RALT,           KC_UP,   KC_DOWN, KC_LBRC, KC_RBRC, KC_LANG1,
                                            CTL_T(KC_ENT),KC_LGUI,KC_SPC,       KC_SPC,KC_RGUI,CTL_T(KC_ENT)
    ),
