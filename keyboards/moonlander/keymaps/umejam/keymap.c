...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_moonlander(
        ...
        KC_TAB,         KC_Q,    KC_W,   KC_E,   KC_R,  KC_T, CTL_T(KC_LBRC),KC_MINS,      KC_Y, KC_U,  KC_I,   KC_O,   KC_P,   KC_EQL,
        KC_BSLS,        KC_A,    KC_S,   KC_D,   KC_F,  KC_G, TG(MDIA),      TG(SYMB),     KC_H, KC_J,  KC_K,   KC_L,   KC_SCLN,KC_QUOT,
        LSFT_T(KC_CAPS),KC_Z,    KC_X,   KC_C,   KC_V,  KC_B,                              KC_N, KC_M,  KC_COMM,KC_DOT, KC_SLSH,RSFT_T(KC_CAPS),
        KC_LEFT,        KC_RIGHT,A(KC_X),KC_GRV,KC_SPC,       KC_LANG2,      KC_LANG1,           KC_SPC,KC_LBRC,KC_RBRC,KC_UP,  KC_DOWN,
    ...
    [SYMB] = LAYOUT_moonlander(
        ...
        KC_TRNS, KC_EXLM, KC_AT,   KC_LCBR, KC_RCBR, KC_PIPE, RESET,             KC_TRNS, KC_UP,   KC_7,    KC_8,    KC_9,    KC_ASTR, KC_F12,
